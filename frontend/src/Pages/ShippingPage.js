		...
		<FormContainer>
			...
			<Form onSubmit={submitHandler}>
				...
				<Form.Group controlId='city' className='m-3'>
					...
					<Form.Control required type='city' placeholder='請輸入城市' value={city ? city : ""} onChange={(e) => setCity(e.target.value)} autoComplete='username'></Form.Control>
				</Form.Group>

				<Form.Group controlId='postalCode' className='m-3'>
					<Form.Label>郵遞區號</Form.Label>
					<Form.Control required type='text' placeholder='請輸入郵遞區號' value={postalCode ? postalCode : ""} onChange={(e) => setPostalCode(e.target.value)} autoComplete='current-password'></Form.Control>
				</Form.Group>

				<Form.Group controlId='country' className='m-3'>
					<Form.Label>國家</Form.Label>
					<Form.Control required type='text' placeholder='請輸入居住國家' value={country ? country : ""} onChange={(e) => setCountry(e.target.value)} autoComplete='new-password'></Form.Control>
				</Form.Group>
